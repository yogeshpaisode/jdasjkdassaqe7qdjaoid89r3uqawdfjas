(function () {
    module.controller("sentMailListController", ["$scope", "SENTList", "settingVal", "$window", "$interval", function ($scope, SENTList, settingVal, $window, $interval) {
        ...
        $scope.fetchMailList = function () {
            ...
            SENTList.query(function (response) {
